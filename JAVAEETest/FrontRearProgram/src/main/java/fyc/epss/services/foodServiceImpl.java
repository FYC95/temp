...
public class foodServiceImpl implements CommonService<food, FoodVO>{
    private CommonDao<food> commonDao = new foodDao();
    @Override
    public Map<String,Object> queryAll(Integer startR, Integer pageSize, FoodVO bvo) {
        ...
        if (bvo==null){
            ...
            if (bvo.getFoodName()!=null){
                condition += "and foodName like '%" +bvo.getFoodName() +"%'";
            }
        }
        ...
        List<food> foodList = commonDao.selectAll(startR, pageSize,condition);
