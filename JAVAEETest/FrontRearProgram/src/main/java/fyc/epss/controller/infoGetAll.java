...
@WebServlet(urlPatterns = "/info/list.do")
public class infoGetAll extends HttpServlet{
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for (String s : cond.split("&")) {
            ...
            if("businessName".equals(ss1[0]) && ss1.length>1)
                businessVO.setPhone(ss1[1]);
        }


        //调用service执行查询业务
        CommonService businessService = new infoServiceImpl();
