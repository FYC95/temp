...
@WebServlet(urlPatterns = "/ordermap/deleteOne.do")
public class ordermapDeleteServlet extends HttpServlet {
    @Override
...
//        Integer id = Integer.valueOf(req.getParameter("id"));
        CommonService orderMapService = new orderMapServiceImpl();

        for (int i = 0; i < idArray.length; i++) {
            b = orderMapService.deleteOne(Integer.valueOf(idArray[i]));
        }
